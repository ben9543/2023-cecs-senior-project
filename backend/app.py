...
CORS(app, resources={r"/api/*": {"origins": "http://ec2-54-151-40-202.us-west-1.compute.amazonaws.com"}})
...
def add_cors_headers(response):
    ...
    response.headers['Access-Control-Allow-Origin'] = 'http://ec2-54-151-40-202.us-west-1.compute.amazonaws.com'
